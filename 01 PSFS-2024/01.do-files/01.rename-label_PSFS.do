...
log using "$psfs_log_files\PSFS_rename.log", replace text
...
use "$psfs_intermediate_dta\01.import-PSFS_intermediate.dta" , clear
...
save "$psfs_intermediate_dta\02.ren-PSFS_intermediate.dta", replace
