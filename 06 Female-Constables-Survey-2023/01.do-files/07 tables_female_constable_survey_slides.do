...
log using "$FC_survey_log_files\femaleconstable_tables_slides.log", replace text
...
/*
label define dum_ps_fourwheeler 0 "No" 1 "Yes"
label values dum_ps_fourwheeler dum_ps_fourwheeler
label define dum_ps_twowheeler 0 "No" 1 "Yes"
label values dum_ps_twowheeler dum_ps_twowheeler
label define dum_ps_computer 0 "No" 1 "Yes"
label values dum_ps_computer dum_ps_computer

gen dum = 0
foreach var of varlist ps_bathroom ps_confidential ps_electricity dum_ps_fourwheeler dum_ps_twowheeler dum_ps_computer ps_seating ps_cleaning ps_water ps_barrack ps_storage ps_evidence ps_phone dum_lockup ps_shelter dum_ps_cctv {
	replace dum = 1 if `var' ==.
}
drop if missing(ps_bathroom, ps_confidential, ps_electricity, dum_ps_fourwheeler, dum_ps_twowheeler, dum_ps_computer, ps_seating, ps_cleaning, ps_water, ps_barrack, ps_storage, ps_evidence, ps_phone, dum_lockup, ps_shelter, dum_ps_cctv)

recode treatment 0=1 1=0

swindex q2001_dum q2002_dum q2003_dum q2004_dum q2005_dum q2006_dum q2007_dum q2008_dum q2009_dum q2010_dum, g(swindex_Perception_Integ) normby(treatment) displayw

swindex q3100_dum q3101_dum q3102_dum q3103_dum q3104_dum, g(swindex_Workenv_Rel) normby(treatment) displayw

swindex q3201_dum q3202_dum q3203_dum q3204_dum, g(swindex_Workenv_Rep) normby(treatment) displayw

swindex q3301_dum q3302_dum q3303_dum q3304_dum q3305_dum, g(swindex_Workenv_Male) normby(treatment) displayw

swindex q3401_dum workdistribution chg_assign_fem chg_assign_m q3406_dum q3407_dum q3408_dum q3409_dum q3410_dum q3411_dum q3412_dum q3413_dum q3414_dum, g(swindex_WorkDistr) normby(treatment) displayw

swindex q4001_dum q4002_dum q4003_dum q4004_dum trainingaware_dum, g(swindex_TrainingLearning) normby(treatment) displayw

swindex h1_dum h1_who_dum h1_reported_dum h2_dum h2_who_dum h2_reported_dum h3_dum h3_who_dum h3_reported_dum h4_dum h4_who_dum h4_reported_dum h5_dum h5_who_dum h5_reported_dum h6_dum h6_who_dum h6_reported_dum, g(swindex_harassment) normby(treatment) displayw

swindex q6001 q6002 q6003 q6004 q6005 q6006 q6007 q6008 q6009 q6010 q6011 q6012 q6013, g(ind_Desirability_And_fem) normby(treatment) displayw
...
label variable swindex_Perception_Integ "perception of workplace integration"
label variable swindex_Workenv_Rel "Work environment (Relationships)"
label variable swindex_Workenv_Rep "Work environment (Representation)"
label variable swindex_Workenv_Male "Work environment (perception of male officers)"
label variable swindex_WorkDistr "Work distribution"
label variable swindex_TrainingLearning "Training Learnings"
label variable swindex_harassment "Harassment"
...
merge m:1 ps_dist_id using "${intermediate_dta}pslist_strata.dta"
replace strata = 0 if _m == 1
drop _m
*/
...
esttab model1 model2 model3 model4 using "${tables}regression_table_`i'_slides.tex" , replace ///
...
cap file close _all
	file open myfile using "${tables}regression_table_`i'_slides.tex", write append
...
foreach i in ind_Perception_Integ ind_Workenv_Rel ind_Workenv_Rep ind_Workenv_Male /*ind_WorkDistr*/ ind_Sensitivity ind_harassment {	
	// Define file paths
	local original "regression_table_`i'_slides.tex"
...
esttab modelq* using "${tables}table_Perception_Work1_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Perception_Work1_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_Perception_Work1_slides.tex"
	local modified "modified_mytable_slides.tex"
...
while r(eof) == 0 {
    ...
    if strpos("`line'", "\begin{table}[htbp]\centering") {
        ...
        file write newfile "\caption{Treatment effects on items in perception of workplace integration (1)}" _n
...
esttab modelq* using "${tables}table_Perception_Work2_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Perception_Work2_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_Perception_Work2_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab modelq* using "${tables}table_WorkEnv_Rel_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_WorkEnv_Rel_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_WorkEnv_Rel_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab modelq* using "${tables}table_WorkEnv_Rep_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_WorkEnv_Rep_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"	
...
cd "$tables" 	
	// Define file paths
	local original "table_WorkEnv_Rep_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab modelq* using "${tables}table_Percep_MaleOff_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Percep_MaleOff_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"	
...
cd "$tables" 	
	// Define file paths
	local original "table_Percep_MaleOff_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model* using "${tables}table_WorkDistribution_1_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_WorkDistribution_1_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
esttab modelq* using "${tables}table_WorkDistribution_2_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_WorkDistribution_2_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
esttab modelq* using "${tables}table_WorkDistribution_3_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_WorkDistribution_3_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
esttab model* using "${tables}table_Sensitivity_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Sensitivity_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"	
...
cd "$tables" 	
	// Define file paths
	local original "table_Sensitivity_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model* using "${tables}table_Harassment_1_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Harassment_1_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_Harassment_1_slides.tex"
	local modified "modified_mytable_slides.tex"
...
while r(eof) == 0 {
    ...
    if strpos("`line'", "\begin{table}[htbp]\centering") {
        file write newfile "\begin{table}[htbp]\centering" _n
        file write newfile "\caption{Treatment effects on items in workplace harassment (1)}" _n
        file write newfile "\resizebox{\textwidth}{!}{" _n
    }
    // Skip the original caption line to avoid duplication
    else if strpos("`line'", "\caption{") {
...
esttab model* using "${tables}table_Harassment_2_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Harassment_2_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_Harassment_2_slides.tex"
	local modified "modified_mytable_slides.tex"
...
while r(eof) == 0 {
    ...
    if strpos("`line'", "\begin{table}[htbp]\centering") {
        file write newfile "\begin{table}[htbp]\centering" _n
        file write newfile "\caption{Treatment effects on items in workplace harassment (2)}" _n
        file write newfile "\resizebox{\textwidth}{!}{" _n
    }
    // Skip the original caption line to avoid duplication
    else if strpos("`line'", "\caption{") {
...
esttab model* using "${tables}table_Harassment_3_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Harassment_3_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_Harassment_3_slides.tex"
	local modified "modified_mytable_slides.tex"
...
while r(eof) == 0 {
    ...
    if strpos("`line'", "\begin{table}[htbp]\centering") {
        file write newfile "\begin{table}[htbp]\centering" _n
        file write newfile "\caption{Treatment effects on items in workplace harassment (3)}" _n
        file write newfile "\resizebox{\textwidth}{!}{" _n
    }
    // Skip the original caption line to avoid duplication
    else if strpos("`line'", "\caption{") {
...
esttab model* using "${tables}table_Indices_And_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Indices_And_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
	file write myfile "  Source: Female constables' survey. \\"
	file write myfile "\hyperlink{Perception_Integ}{\beamergotobutton {(1) Perception of workplace integration}} \\"
	file write myfile "\hyperlink{Workenv_Rel}{\beamergotobutton {(2) Work environment (relationships)}} \\"
	file write myfile "\hyperlink{Workenv_Rep}{\beamergotobutton {(3) Work environment (representation)}} \\"
	file write myfile "\hyperlink{Workenv_Male}{\beamergotobutton {(4) Work environment (perception of male officers)}}  \\"
	file write myfile "\hyperlink{Workenv_Male}{\beamergotobutton {(5) Male officers' sensitivity towards females}} \\"
	file write myfile "\hyperlink{harassment}{\beamergotobutton {(6) Harassment in the workplace}}"
	file write myfile "\end{tiny}"
	file write myfile "\end{flushleft}"
	file close myfile
...
cd "$tables" 	
	// Define file paths
	local original "table_Indices_And_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model* using "${tables}table_Indices_Reg_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_Indices_Reg_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"	
...
cd "$tables" 	
	// Define file paths
	local original "table_Indices_Reg_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model1 model2 model3 using "${tables}regression_table_`i'_treatSDB_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
...
cap file close _all
	file open myfile using "${tables}regression_table_`i'_treatSDB_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
foreach i in ind_Perception_Integ ind_Workenv_Rel ind_Workenv_Rep ind_Workenv_Male /*ind_WorkDistr*/ ind_Sensitivity ind_harassment {	
	// Define file paths
	local original "regression_table_`i'_treatSDB_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model1 model2 model3 model4 using "${tables}regression_table_`i'_treatfem_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
...
cap file close _all
	file open myfile using "${tables}regression_table_`i'_treatfem_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
foreach i in ind_Perception_Integ ind_Workenv_Rel ind_Workenv_Rep ind_Workenv_Male /*ind_WorkDistr*/ ind_Sensitivity ind_harassment {	
	// Define file paths
	local original "regression_table_`i'_treatfem_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model1 model2 model3 model4 using "${tables}regression_table_`i'_treaturban_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
...
cap file close _all
	file open myfile using "${tables}regression_table_`i'_treaturban_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
foreach i in ind_Perception_Integ ind_Workenv_Rel ind_Workenv_Rep ind_Workenv_Male /*ind_WorkDistr*/ ind_Sensitivity ind_harassment {	
	// Define file paths
	local original "regression_table_`i'_treaturban_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab model* using "${tables}table_direct_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_direct_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_direct_slides.tex"
	local modified "modified_mytable_slides.tex"
...
esttab modelq* using "${tables}table_indirect_slides.tex" , replace ///
	b(2) se(2)  label noconstant booktabs ///
	star(* 0.10 ** 0.05 *** 0.01) r2 ///
	noobs ///
	keep (treatment) ///
...
cap file close _all
	file open myfile using "${tables}table_indirect_slides.tex", write append
	file write myfile "\vspace{-\baselineskip}"
	file write myfile "\begin{flushleft}"
	file write myfile "\begin{tiny}"
	file write myfile "\raggedright"
...
cd "$tables" 	
	// Define file paths
	local original "table_indirect_slides.tex"
	local modified "modified_mytable_slides.tex"
