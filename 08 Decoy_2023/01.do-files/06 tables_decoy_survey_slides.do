...
esttab model1 model2 model3 model4 using "$decoy_tables\regression_table_`i'_slides.tex" , replace ///
...
cap file close _all
	file open myfile using "$decoy_tables\regression_table_`i'_slides.tex", write append
	...
	file write myfile " Source: Decoy survey."
