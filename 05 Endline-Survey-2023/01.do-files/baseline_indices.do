/*==============================================================================
File Name: Baseline Officer's Survey 2022 - Redoing Indices
...
*Notes READ ME:
*This is the Do file to redo indices on the Baseline Officer's Survey 2022. 
...
if "`c(username)'"=="HP"{
	global dropbox "C:\Users\HP\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\Baseline-Survey-2022\Officer-Survey-v3-2023"
	}	
...
log using "${log_files}officersurvey_indices.log", replace text

* We will add this line from time to time if the program takes time to compute or uses a lot of loops
noisily display as text "The date is " as result "--$S_DATE--" as text " and the time is " as result "--$S_TIME--"


use "${intermediate_dta}01.officersurvey_clean_deidentified_combined.dta" , clear
...
save "${intermediate_dta}baseline_indices.dta", replace