...
log using "$MO_endline_log_files\balance_mainsurvey.log", replace text

* We will add this line from time to time if the program takes time to compute or uses a lot of loops
noisily display as text "The date is " as result "--$S_DATE--" as text " and the time is " as result "--$S_TIME--"

use "$MO_endline_clean_dta\endline_secondaryoutcomes.dta"


gen dum_ttoc_notransfer =.
replace dum_ttoc_notransfer = 0 if dum_transfer == 0 & dum_baseline == 1
replace dum_ttoc_notransfer = 1 if dum_transfer_ttoc == 1 & dum_baseline == 1
...
global po_indices_And_bl "index_VictimBlame_And_bl index_Techskills_And_bl index_Empathy_And_bl index_Flexibility_And_bl index_Desirability_And_bl index_AttitudeGBV_And_bl index_ExtPol_And_bl index_Discrimination_And_bl index_Truth_And_bl index_Openness_And_bl" 

global po_indices_Reg_bl "index_VictimBlame_Reg_bl index_Techskills_Reg_bl index_Empathy_Reg_bl index_Flexibility_Reg_bl index_Desirability_Reg_bl index_AttitudeGBV_Reg_bl index_ExtPol_Reg_bl index_Discrimination_Reg_bl index_Truth_Reg_bl index_Openness_Reg_bl"
...
****Balance for randomisation - Simple control v treatment

balancetable (mean if dum_baseline == 1 & treatment_bl == 0) (mean if dum_baseline == 1 & treatment_bl == 1) ///
(diff treatment_bl if dum_baseline == 1 & treatment_bl !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_SES_baseline.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & treatment_bl == 0) (mean if dum_baseline == 1 & treatment_bl == 1) ///
(diff treatment_bl if dum_baseline == 1 & treatment_bl !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_SES_baseline.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & treatment_bl == 0) (mean if dum_baseline == 1 & treatment_bl == 1) ///
(diff treatment_bl if dum_baseline == 1 & treatment_bl !=.) ///
$po_indices_And_bl using "$MO_endline_tables\balance_indices_baseline_And.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & treatment_bl == 0) (mean if dum_baseline == 1 & treatment_bl == 1) ///
(diff treatment_bl if dum_baseline == 1 & treatment_bl !=.) ///
$po_indices_And_bl using "$MO_endline_tables\balance_indices_baseline_And.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & treatment_bl == 0) (mean if dum_baseline == 1 & treatment_bl == 1) ///
(diff treatment_bl if dum_baseline == 1 & treatment_bl !=.) ///
$po_indices_Reg_bl using "$MO_endline_tables\balance_indices_baseline_Reg.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & treatment_bl == 0) (mean if dum_baseline == 1 & treatment_bl == 1) ///
(diff treatment_bl if dum_baseline == 1 & treatment_bl !=.) ///
$po_indices_Reg_bl using "$MO_endline_tables\balance_indices_baseline_Reg.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///


****Balance for transfers - Transferred officers v non-transferred officers

balancetable (mean if dum_baseline == 1 & dum_transfer == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_transfer if dum_baseline == 1 & dum_transfer !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_SES_transfers_baseline.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_transfer if dum_baseline == 1 & dum_transfer !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_SES_transfers_baseline.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_transfer if dum_baseline == 1 & dum_transfer !=.) ///
$po_indices_And_bl using "$MO_endline_tables\balance_transfers_And.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_transfer if dum_baseline == 1 & dum_transfer !=.) ///
$po_indices_And_bl using "$MO_endline_tables\balance_transfers_And.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_transfer if dum_baseline == 1 & dum_transfer !=.) ///
$po_indices_Reg_bl using "$MO_endline_tables\balance_transfers_Reg.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_transfer if dum_baseline == 1 & dum_transfer !=.) ///
$po_indices_Reg_bl using "$MO_endline_tables\balance_transfers_Reg.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///


****Balance for transfers - Transferred (treatment to control) v non-transferred officers

balancetable (mean if dum_baseline == 1 & dum_transfer == 1 & dum_transfer_ttoc == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_ttoc_notransfer if dum_ttoc_notransfer !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_SES_ttoc_baseline.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1 & dum_transfer_ttoc == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_ttoc_notransfer if dum_ttoc_notransfer !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_SES_ttoc_baseline.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1 & dum_transfer_ttoc == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_ttoc_notransfer if dum_ttoc_notransfer !=.) ///
$po_indices_And_bl using "$MO_endline_tables\balance_ttoc_And.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1 & dum_transfer_ttoc == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_ttoc_notransfer if dum_ttoc_notransfer !=.) ///
$po_indices_And_bl using "$MO_endline_tables\balance_ttoc_And.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1 & dum_transfer_ttoc == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_ttoc_notransfer if dum_ttoc_notransfer !=.) ///
$po_indices_Reg_bl using "$MO_endline_tables\balance_ttoc_Reg.xlsx", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_baseline == 1 & dum_transfer == 1 & dum_transfer_ttoc == 1) (mean if dum_baseline == 1 & dum_transfer == 0) ///
(diff dum_ttoc_notransfer if dum_ttoc_notransfer !=.) ///
$po_indices_Reg_bl using "$MO_endline_tables\balance_ttoc_Reg.tex", covariates(ps_dist_bl strata) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred" "Not Transferred" "Diff b/w (1) and (2)") varla ///
...
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_attrition_main.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
...
balancetable (mean if dum_bothsurveys == 1 & dum_transfer == 1)(mean if dum_bothsurveys == 1 & treatment_bl == 0 & dum_transfer == 1) (mean if dum_bothsurveys == 1 & treatment_bl == 1 & dum_transfer == 1) (mean if dum_bothsurveys == 1 & dum_transfer == 0) (mean if dum_bothsurveys == 1 & treatment_bl == 0 & dum_transfer == 0) (mean if dum_bothsurveys == 1 & treatment_bl == 1 & dum_transfer == 0) ///
(diff dum_notransfer_control if dum_notransfer_control !=.)(diff dum_notransfer_treatment if dum_notransfer_treatment !=.) ///
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_attrition_main.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Transferred Officers-Within Sample" "Transferred Officers-Control" "Transferred Officers-Treatment" "Non-Transferred Officers" "Non-Transferred Officers-Control" "Non-Transferred Officers-Treatment" "Diff b/w (2) and (5)" "Diff b/w (3) and (6)") varla ///
...
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_transfers.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
...
balancetable (mean if dum_bothsurveys == 1 & dum_transfer == 0) (mean if dum_transfer_ctoc == 1) (mean if dum_transfer_ttot == 1) (mean if dum_transfer_ctot == 1) (mean if dum_transfer_ttoc == 1) ///
(diff dum_ctoc_transfer if dum_ctoc_transfer !=.) (diff dum_ttot_transfer if dum_ttot_transfer !=.) (diff dum_ctot_transfer if dum_ctot_transfer !=.) (diff dum_ttoc_transfer if dum_ttoc_transfer !=.) ///
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_transfers.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Non-Transferred Officers" "Transferred from C to C" "Transferred from T to T" "Transferred from C to T" "Transferred from T to C" "Diff b/w (1) and (2)" "Diff b/w (1) and (3)" "Diff b/w (1) and (4)" "Diff b/w (1) and (5)") varla ///
...
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_transfers_outsample.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Non-Transferred Officers" "Officers Transferred out of Sample" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_bothsurveys == 1 & dum_transfer == 0) (mean if dum_baselineonly == 1) ///
(diff dum_baseline_transfer_out if dum_baseline_transfer_out !=.) ///
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_transfers_outsample.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Non-Transferred Officers" "Officers Transferred out of Sample" "Diff b/w (1) and (2)") varla ///
...
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_transfers_replacement.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Non-Transferred Officers" "Officers Transferred into the Sample" "Diff b/w (1) and (2)") varla ///

balancetable (mean if dum_bothsurveys == 1 & dum_transfer == 0) (mean if dum_endlineonly == 1) ///
(diff dum_outsample if dum_outsample !=.) ///
$characteristics_bl $po_indices_bl using "$MO_endline_tables\balance_transfers_replacement.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Non-Transferred Officers" "Officers Transferred into the Sample" "Diff b/w (1) and (2)") varla ///
...
$po_indices_bl using "$MO_endline_tables\balance_indices.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$po_indices_bl using "$MO_endline_tables\balance_indices.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///
...
balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_demography.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$characteristics_bl using "$MO_endline_tables\balance_demography.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///
...
balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$VB $TS using "$MO_endline_tables\balance_victimblaming.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$VB $TS using "$MO_endline_tables\balance_victimblaming.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$Emp $Atti using "$MO_endline_tables\balance_empathy.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$Emp $Atti using "$MO_endline_tables\balance_empathy.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$Ext $Truth using "$MO_endline_tables\balance_externalising.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$Ext $Truth using "$MO_endline_tables\balance_externalising.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///
...
balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$psfs_indices using "$MO_endline_tables\balance_psfs.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///

balancetable (mean if treatment_bl == 0) (mean if treatment_bl == 1) ///
(diff treatment_bl if treatment_bl !=.) ///
$psfs_indices using "$MO_endline_tables\balance_psfs.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Control" "Treatment" "Diff b/w (1) and (2)") varla ///
...
$psfs_indices using "$MO_endline_tables\balance_decoy.xlsx", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Decoy - Control" "Decoy - Treatment" "Non-decoy - Control" "Non-decoy - Treatment" "Diff b/w (1) and (3)" "Diff b/w (2) and (4)" ) varla ///

balancetable (mean if dum_decoy == 1 & treatment_bl == 0) (mean if dum_decoy == 1 & treatment_bl == 1) (mean if dum_decoy == 0 & treatment_bl == 0) (mean if dum_decoy == 0 & treatment_bl == 1) ///
(diff dum_decoy_control if treatment_bl == 0) (diff dum_decoy_treatment if treatment_bl == 1) ///
$psfs_indices using "$MO_endline_tables\balance_decoy.tex", covariates(ps_dist_bl) vce(cluster ps_dist_id_bl) replace ///
ctitles("Decoy - Control" "Decoy - Treatment" "Non-decoy - Control" "Non-decoy - Treatment" "Diff b/w (1) and (3)" "Diff b/w (2) and (4)" ) varla ///
