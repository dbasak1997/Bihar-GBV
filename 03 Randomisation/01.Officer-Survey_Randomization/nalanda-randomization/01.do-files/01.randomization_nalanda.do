/*==============================================================================
File Name:	Randomization: Nalanda Baseline-Survey-2023
...
*/ 
	...
	global dropbox "C:\Users\dibbo\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\03 Randomisation\01.Officer-Survey_Randomization\nalanda-randomization"
	}
	
else if "`c(username)'"=="Acer"{
	global dropbox "D:\Dropbox_SB\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\Randomization-2022\01.Officer-Survey_Randomization\nalanda-randomization"
	}
...
log using "${log_files}randomisation_nalanda.log", replace text
...
//We have 15 PS with above median number of Police Officers and 25 PS with below median Police Officers strength. 
...
*********************************************
use "${intermediate_dta}1007_nalanda-merged_prep.dta", clear

merge m:1 ps_dist_id using "${intermediate_dta}randomization_nalanda.dta", gen(mergeT) // Complete match
...
cap n			outreg2  using "${tables}randomization_nalanda.xls" , label excel dec(3) drop() append addtext(Mean of control, `meanY', Mean of treatment, `meanYT', Strata FE, Yes, Cluster Station, Yes) ctitle ("`var'") nocons 
...
export excel ps_dist_id ps_name ps_confirm  T using "${clean_dta}treatment-nalanda.xls", firstrow(variables) replace
