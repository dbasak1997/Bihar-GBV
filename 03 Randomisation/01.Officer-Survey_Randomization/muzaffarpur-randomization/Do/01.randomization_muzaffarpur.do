/*==============================================================================
File Name:	Randomization: Muzaffarpur Baseline-Survey-2022
...
*/ 
	...
	global dropbox "C:\Users\dibbo\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\03 Randomisation\01.Officer-Survey_Randomization\muzaffarpur-randomization"
	}
	
else if "`c(username)'"=="Acer"{
	global dropbox "D:\Dropbox_SB\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\Randomization-2022\01.Officer-Survey_Randomization\muzaffarpur-randomization"
	}
...
log using "${log}randomization-muzzafarpur.log", replace text
...
//We have 13 PS with above median number of Police Officers and 25 PS with below median Police Officers strength. 
...
use "$dta\1006_muzaffarpur-merged_prep.dta", clear


merge m:1 ps_dist_id using "$dta\randomization_muzaffarpur.dta", gen(mergeT)
...
cap n erase "$table\randomization_muzaffarpur.xls"
...
cap n			outreg2  using "$table\randomization_muzaffarpur.xls" , label excel dec(3) drop() append addtext(Mean of control, `meanY', Mean of treatment, `meanYT', Strata FE, Yes, Cluster Station, Yes) ctitle ("`var'") nocons 
...
export excel gbv_uid ps_dist_id ps_name ps_confirm  T using "$table\list_muzaffarpur.xls", firstrow(variables) replace
