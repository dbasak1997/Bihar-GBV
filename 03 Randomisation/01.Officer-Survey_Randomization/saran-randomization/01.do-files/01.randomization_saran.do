/*==============================================================================
File Name:	Randomization: Saran Baseline-Survey-2023
...
*/ 
	...
	global dropbox "C:\Users\dibbo\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\03 Randomisation\01.Officer-Survey_Randomization\saran-randomization"
	}
	
else if "`c(username)'"=="Acer"{
	global dropbox "D:\Dropbox_SB\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\Randomization-2022\01.Officer-Survey_Randomization\saran-randomization"
	}
...
if "`c(username)'"=="HP"{
	...
	global source "C:\Users\dibbo\Dropbox\Debiasing Police in India\005-Data-and-analysis-2022\02 Baseline-Survey-2022\Baseline Survey_versions 1-3\Officer-Survey-v3-2023\06.clean-data\psfs-officer_merged"
	} 
...
log using "${log_files}randomisation_saran.log", replace text
...
use "$source\1009_saran-merged.dta"
...
//We have 15 PS with above median number of Police Officers and 21 PS with below median Police Officers strength. 

save "${intermediate_dta}1009_saran-merged_prep.dta", replace
...
save "${intermediate_dta}randomization_saran.dta", replace
...
*********************************************
use "${intermediate_dta}1009_saran-merged_prep.dta", clear

merge m:1 ps_dist_id using "${intermediate_dta}randomization_saran.dta", gen(mergeT) // Complete match
...
cap n			outreg2  using "${tables}randomization_saran.xls" , label excel dec(3) drop() append addtext(Mean of control, `meanY', Mean of treatment, `meanYT', Strata FE, Yes, Cluster Station, Yes) ctitle ("`var'") nocons 
...
export excel ps_dist_id ps_name ps_confirm  T using "${clean_dta}treatment-saran.xls", firstrow(variables) replace
